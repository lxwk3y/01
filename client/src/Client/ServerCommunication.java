                ...
                if (parts.length == 2) {
                    ...
                    switch (header) {
                        ...
                        case "SENDFILE_REQ":
                            ...
                            initializeManager.getProtocolManager().getFileTransferProtocol().setRole("sender");
                        ...
                        case "FILETRANSFER_ACCEPT":
                            initializeManager.getProtocolManager().getFileTransferProtocol().setRole("receiver");
                            initializeManager.getProtocolManager().getFileTransferProtocol().run();
                            break;
                        default:
